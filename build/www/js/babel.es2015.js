                                                ...
                                                "ban": {
                                                        ...
                                                        items: {
                                                                "temp": {
                                                                        name: "Tempban",
                                                                        items: {
                                                                                "ban_1m": { name: "1 Minute", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 1] });
                                                                                        } },
                                                                                "ban_5m": { name: "5 Minutes", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 5] });
                                                                                        } },
                                                                                "ban_10m": { name: "10 Minutes", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 10] });
                                                                                        } },
                                                                                "ban_30m": { name: "30 Minutes", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 30] });
                                                                                        } },
                                                                                "ban_1h": { name: "1 Hour", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 60] });
                                                                                        } },
                                                                                "ban_2h": { name: "2 Hours", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 120] });
                                                                                        } },
                                                                                "ban_5h": { name: "5 Hours", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 300] });
                                                                                        } },
                                                                                "ban_10h": { name: "10 Hours", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 600] });
                                                                                        } },
                                                                                "ban_16h": { name: "16 Hours", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 960] });
                                                                                        } }
                                                                        }
                                                                },
                                                                "perm": {
                                                                        name: "Ban",
                                                                        items: {
                                                                                "ban_1d": { name: "1 Day", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 1440] });
                                                                                        } },
                                                                                "ban_2d": { name: "2 Days", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 2880] });
                                                                                        } },
                                                                                "ban_3d": { name: "3 Days", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 4320] });
                                                                                        } },
                                                                                "ban_4d": { name: "4 Days", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 5760] });
                                                                                        } },
                                                                                "ban_5d": { name: "5 Days", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 7200] });
                                                                                        } },
                                                                                "ban_6d": { name: "6 Days", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 8640] });
                                                                                        } },
                                                                                "ban_1w": { name: "1 Week", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 10080] });
                                                                                        } },
                                                                                "ban_2w": { name: "2 Weeks", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 20160] });
                                                                                        } },
                                                                                "ban_1mo": { name: "1 Month", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 43200] });
                                                                                        } },
                                                                                "ban_12mo": { name: "12 Months", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 525600] });
                                                                                        } },
                                                                                "ban_2y": { name: "2 Years", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 1051200] });
                                                                                        } },
                                                                                "ban_5y": { name: "5 Years", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 2628000] });
                                                                                        } },
                                                                                "ban_forever": { name: "Permanent (Invalid Date)", callback: function callback() {
                                                                                                socket.emit("command", { list: ["ban", _this2.id, prompt("Reason:"), 999999999] });
                                                                                        } }
                                                                        }
                                                                }
                                                        }
