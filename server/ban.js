...
exports.addBan = function(ip, length, reason) {
        ...
        for (var i = 0; i < socketList.length; i++) {
                ...
                let socketIp = socket.request.headers['x-forwarded-for'] || socket.request.connection.remoteAddress;
                if (socketIp && socketIp.includes(',')) socketIp = socketIp.split(',')[0].trim();
